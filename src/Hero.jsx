  ...
  const Particle = ({ index, type = "default" }) => {
    ...
    return (
      <motion.div
        ...
        className={`absolute rounded-full bg-gradient-to-r from-purple-400/40 to-violet-400/40 ${type === "large" ? "w-2 h-2" : "w-1 h-1"}`}
      />
    );
  };
  ...
  return (
    ...
    >
          ...
          <div className="absolute inset-0 opacity-[0.08]">
            {Array.from({ length: 20 }).map((_, i) => (
              <motion.div
                ...
                className="absolute text-xs font-mono text-purple-300/60"
                style={{
        ...
        <div className="absolute inset-0 pointer-events-none">
          {["sm", "md", "lg"].map((size, idx) => (
            ...
            >
              ...
              >
                {size === "sm" ? (
                  <Code2 className="w-full h-full text-purple-300" />
                ) : size === "md" ? (
      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="order-1">
            <motion.div variants={fadeInUp} className="mb-6 md:mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-500/20 to-violet-500/20 backdrop-blur-sm border border-purple-400/30">
                <motion.div
                  animate={{ rotate: 360 }}
                  transition={{ duration: 10, repeat: Infinity, ease: "linear" }}
                >
                  <Sparkles className="w-3.5 h-3.5 md:w-4 md:h-4 text-purple-300" />
                </motion.div>
                <span className="text-sm md:text-base font-medium text-purple-100">
            ...
            <motion.div variants={slideInLeft}>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 leading-tight">
                <span className="block text-purple-100">Hi, I'm</span>
                <span className="block bg-gradient-to-r from-purple-300 via-violet-200 to-purple-400 bg-clip-text text-transparent">
                  {typedName}
                  <motion.span
                    className="inline-block w-0.5 h-8 md:h-12 ml-1 bg-purple-400"
              ...
              <div className="mb-6 md:mb-8">
                <motion.h2
                  className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-purple-200/90 mb-3 md:mb-4 leading-relaxed"
                  variants={fadeInUp}
                >
                  Full Stack Developer &<br className="hidden sm:block" /> UI/UX Specialist
                </motion.h2>

                <motion.p
                  className="text-base sm:text-lg text-purple-100/80 leading-relaxed"
                  variants={fadeInUp}
                >
                  I build exceptional digital experiences that are fast, accessible, visually appealing,
                  and responsive. Let's bring your ideas to life with modern web technologies.
                </motion.p>
              </div>
            </motion.div>
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className="p-3 sm:p-4 rounded-xl bg-gradient-to-br from-violet-900/40 to-purple-900/40 backdrop-blur-sm border border-purple-400/20 hover:border-purple-300/40 transition-all duration-300"
                >
                  <div className="flex items-center gap-2 mb-1">
                    <stat.icon className="w-3.5 h-3.5 md:w-4 md:h-4 text-purple-300" />
                    <motion.div
                      animate={{
                        scale: hoveredCard === `stat-${i}` ? [1, 1.1, 1] : 1,
                      }}
                      transition={{ duration: 0.4 }}
                      className="text-xl sm:text-2xl md:text-3xl font-bold text-purple-300"
                    >
                      {stat.value}
                      <span className="text-purple-400">{stat.suffix}</span>
                    </motion.div>
                  </div>
                  <div className="text-xs sm:text-sm text-purple-200/70 font-medium">{stat.label}</div>
                </motion.div>
              ))}
            </motion.div>
            ...
            >
              <motion.button
                ...
                className="group relative px-6 sm:px-8 py-3 bg-gradient-to-r from-purple-500 to-violet-600 text-white font-semibold rounded-xl overflow-hidden transition-all duration-300"
              >
                ...
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-purple-400 to-violet-500"
                  initial={{ x: "-100%" }}
                  whileHover={{ x: 0 }}
                  transition={{ duration: 0.4 }}
                />
              ...
              <motion.button
                ...
                className="px-6 sm:px-8 py-3 bg-violet-950/60 backdrop-blur-sm border border-purple-400/30 text-purple-100 font-semibold rounded-xl hover:bg-violet-900/70 hover:border-purple-300/50 transition-all duration-300 text-sm sm:text-base"
              >
                Get In Touch
              </motion.button>
            </motion.div>
          ...
          <div className="order-2 lg:order-2 relative mt-8 lg:mt-0">
            <div className="relative h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] xl:h-[500px]">
              {[
                { icon: Cpu, label: "Frontend", color: "sky", position: "top-0 left-4 sm:left-8 md:left-1/4", rotation: -6, content: "React, Vue, Next.js" },
                { icon: Server, label: "Backend", color: "blue", position: "top-1/3 right-4 sm:right-8 md:right-0", rotation: 4, content: "Node.js, Express, Django" },
                { icon: Database, label: "Database", color: "cyan", position: "bottom-1/3 left-4 sm:left-8 md:left-0", rotation: -3, content: "MongoDB, PostgreSQL" },
                { icon: Cloud, label: "Cloud", color: "indigo", position: "bottom-0 right-4 sm:right-8 md:right-1/4", rotation: 5, content: "AWS, Vercel, Docker" },
              ].map((tech, i) => {
                ...
                return (
                  <motion.div
                    ...
                    onHoverEnd={() => setHoveredCard(null)}
                    className={`absolute ${tech.position} w-40 sm:w-44 md:w-48 lg:w-52 xl:w-56 p-4 sm:p-5 md:p-6 rounded-2xl bg-gradient-to-br from-violet-900/40 to-purple-900/40 backdrop-blur-xl ${colorClass.border} transition-all duration-300 cursor-pointer shadow-lg ${colorClass.glow}`}
                  >
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs sm:text-sm text-purple-100/70 leading-tight">{tech.content}</p>
                        <motion.div
                          initial={{ width: 0 }}
            ...
            >
              {[
                ...
                { icon: Terminal, label: "Node.js", color: "indigo" },
                { icon: Brain, label: "AI/ML", color: "sky" },
                ...
                return (
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg backdrop-blur-sm ${colorClass.border} bg-violet-900/20 transition-all duration-200`}
                  >
                    <tech.icon className={`w-3.5 h-3.5 sm:w-4 sm:h-4 ${colorClass.text}`} />
                    <span className="text-xs sm:text-sm font-medium text-purple-100 whitespace-nowrap">
                      {tech.label}
                    </span>
                  </motion.div>
                );
        ...
        >
          <motion.button
            ...
            className="flex flex-col items-center gap-2 text-purple-300 hover:text-purple-100 transition-colors group"
      ...
      <motion.button
        ...
        onClick={() => scrollToSection("about")}
        className="fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-50 lg:hidden p-2.5 sm:p-3 rounded-full bg-violet-950/80 backdrop-blur-xl border border-purple-400/30 shadow-lg"
